...
//		//n_page = Integer.parseInt(JOptionPane.showInputDialog("ï¿½ltimo ï¿½ndice"));
...
//		//System.out.print(nome_busca);
	...
	public static String[] getNomes(String nome_busca, String Str_n_page) throws IOException {		
		if(Str_n_page!=null && isFLAG_LOOP()) {  //se nÃ£o vier nada no campo de pagina e eh a primeira execucao, pega o q estiver no arq properties
			carregaArquivoProp();  //puxa do arquivo jÃ¡ em inteiro
			setFLAG_LOOP(false);
		}
